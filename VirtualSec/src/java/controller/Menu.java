            ...
            case 1:
                ...
                switch (acao) {
                    ...
                    case "editar_prof":
                        ...
                        List listEditaProf = ProfDao.getSingleList(id_prof);
                        request.getSession().setAttribute("professor_editado", ProfDao.getSingle(id_prof));
                        request.setAttribute("profEditar", listEditaProf);
