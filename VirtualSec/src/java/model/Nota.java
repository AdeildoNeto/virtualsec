...
public class Nota {
    ...
    /**
     * @param lideranca the lideranca to set
     */
    ...
    /**
     * @return the trabEquipe
     */
    public float getTrabEquipe() {
        return trabEquipe;
    }

    /**
     * @param trabEquipe the trabEquipe to set
     */
    public void setTrabEquipe(float trabEquipe) {
    ...
    /**
     * @param aptidao the aptidao to set
     */
